...
*Published on January 6, 2026*
  ...
  },
  {
    ...
    excerpt:
      "Most agent skills are just prompts. They tell an AI what to do, but rely on the host environment to actually do it. What if skills could execute themselves?",
    date: "2024-12-29",
    author: "Enact Team",
    slug: "should-skills-be-executable",
    tags: ["skills", "agents", "architecture"],
    content: `
...
So sure you could eventually write a skill that works for this user's specific issue, but I think this is an environment problem more than a skill writing problem.
