 ...
 */
export function verifyCommandSafety(command: string, tool: EnactTool): {
  isSafe: boolean;
  warnings: string[];
  blocked?: string[];
} {
 ...
 */
export function sanitizeEnvironmentVariables(envVars: Record<string, any>): Record<string, string> {
