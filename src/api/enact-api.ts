...
export class EnactApiClient {
   ...
   */
  async getToolsByTags(tags: string[], limit: number = 20): Promise<EnactToolDefinition[]> {
   ...
   * Get tools by author
   */
  async getToolsByAuthor(author: string, limit: number = 20): Promise<EnactToolDefinition[]> {
